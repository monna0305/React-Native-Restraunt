    ...
    return (
        <View style={styles.header}>
            ...
            >
                ...
                <Text style={{color: '#fff', fontSize: 18}}>return</Text>
            </TouchableOpacity>
        </View>
    )
}
...
const ScannerPromptTitle = () => {
    return (
        <View style={{marginTop: 30, flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
            ...
            <Text style={{color: '#fff', fontSize: 18}}>Please put the food barcode in the circle</Text>
        </View>
    )
}
        ...
        return (
            <View style={styles.scanPromptWrapper}>
                <View style={styles.scanPrompt}>
                    <Text style={{color: '#fff', fontSize: 19}}>Scanned successfully!</Text>
                    <Text style={{color: '#fff', fontSize: 19, marginTop: 10}}>Jumping to your page, please wait!</Text>
                </View>
            </View>
        )
    }
